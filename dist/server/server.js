...
async function getStartManifest(matchedRoutes) {
  var _a;
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Bju3FWpn.js");
...
const manifest = {
  "5cb8c752510335e707b5688104581db46303f437afaebc436b245c16a1cdbe97": {
    functionName: "getTreeData_createServerFn_handler",
    importer: () => import("./assets/index-CF8mBGfJ.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-CSKEJGcD.js").then((n) => n.r),
